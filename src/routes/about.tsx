  ...
  head: () => ({
    meta: [
      { title: "About — TailorHub Atelier" },
      {
        name: "description",
        content:
          "The story, craft and people behind TailorHub — a bespoke tailoring atelier established in 1998.",
      },
      ...
      <main className="pt-24">
        <section className="mx-auto max-w-7xl px-6 py-16">
          <SectionHeader
            ...
            title={
              <>
                Cut, cloth and <em className="text-gradient-gold not-italic">conviction</em> since
                1998
              </>
            }
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                To make bespoke feel personal again — one client, one pattern, one perfect suit at a
                time.
              </p>
            </div>
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                A house where craft outlives trend, and every garment is a small argument for doing
                things properly.
              </p>
            </div>
          </div>
            ...
            <ol className="mx-auto mt-14 max-w-3xl space-y-8">
              {timeline.map((item) => (
                <li key={item.y} className="flex gap-6">
                  <div className="text-gradient-gold shrink-0 font-display text-3xl w-24">
                    {item.y}
                  </div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-28">
          <img
            ...
            alt="Cloths"
            loading="lazy"
            className="rounded-3xl object-cover w-full aspect-[16/7]"
          />
        </section>
      </main>
      <Footer />
